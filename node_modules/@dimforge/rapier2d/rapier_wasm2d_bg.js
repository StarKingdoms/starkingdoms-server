    ...
    */
    createCollider(shape, translation, rotation, useMassProps, mass, centerOfMass, principalAngularInertia, density, friction, restitution, frictionCombineRule, restitutionCombineRule, isSensor, collisionGroups, solverGroups, activeCollisionTypes, activeHooks, activeEvents, hasParent, parent, bodies) {
        try {
            ...
            wasm.rawcolliderset_createCollider(retptr, this.ptr, shape.ptr, translation.ptr, rotation.ptr, useMassProps, mass, centerOfMass.ptr, principalAngularInertia, density, friction, restitution, frictionCombineRule, restitutionCombineRule, isSensor, collisionGroups, solverGroups, activeCollisionTypes, activeHooks, activeEvents, hasParent, parent, bodies.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
...
export class RawContactManifold {
    ...
    */
    contact_tangent_impulse(i) {
        var ret = wasm.rawcontactmanifold_contact_tangent_impulse(this.ptr, i);
        return ret;
    }
    /**
    * @returns {number}
...
export class RawJointParams {
    ...
    */
    static prismatic(anchor1, axis1, anchor2, axis2, limitsEnabled, limitsMin, limitsMax) {
        ...
        var ret = wasm.rawjointparams_prismatic(anchor1.ptr, axis1.ptr, anchor2.ptr, axis2.ptr, limitsEnabled, limitsMin, limitsMax);
...
export class RawRayColliderIntersection {
    ...
    */
    toi() {
        var ret = wasm.rawraycolliderintersection_toi(this.ptr);
        return ret;
    }
}
/**
...
export class RawRigidBodySet {
    ...
    */
    rbApplyTorque(handle, torque, wakeUp) {
        wasm.rawrigidbodyset_rbApplyTorque(this.ptr, handle, torque, wakeUp);
    }
    /**
    ...
    */
    createRigidBody(translation, rotation, gravityScale, mass, transationsEnabled, centerOfMass, linvel, angvel, principalAngularInertia, rotationsEnabled, linearDamping, angularDamping, rb_type, canSleep, ccdEnabled, dominanceGroup) {
        ...
        _assertClass(centerOfMass, RawVector);
        _assertClass(linvel, RawVector);
        var ret = wasm.rawrigidbodyset_createRigidBody(this.ptr, translation.ptr, rotation.ptr, gravityScale, mass, transationsEnabled, centerOfMass.ptr, linvel.ptr, angvel, principalAngularInertia, rotationsEnabled, linearDamping, angularDamping, rb_type, canSleep, ccdEnabled, dominanceGroup);
        return ret >>> 0;
    }
    /**
    * @param {number} handle
...
export class RawRotation {
    ...
    */
    get im() {
        var ret = wasm.rawrotation_im(this.ptr);
        return ret;
    }
    /**
    ...
    */
    get angle() {
        var ret = wasm.rawrotation_angle(this.ptr);
        return ret;
    }
}
/**
...
export class RawShape {
    ...
    */
    static heightfield(heights, scale) {
        ...
        var ret = wasm.rawshape_heightfield(ptr0, len0, scale.ptr);
        return RawShape.__wrap(ret);
    }
    /**
    * @param {RawVector} p1
...
export class RawVector {
    ...
    */
    xy() {
        var ret = wasm.rawvector_xy(this.ptr);
        return RawVector.__wrap(ret);
    }
    /**
    ...
    */
    yx() {
        var ret = wasm.rawvector_yx(this.ptr);
        return RawVector.__wrap(ret);
    }
}
...
export function __wbg_now_885ca88fafee0fd1(arg0) {
...
export function __wbg_call_c143b19d87139944() { return handleError(function (arg0, arg1, arg2, arg3) {
    var ret = getObject(arg0).call(getObject(arg1), getObject(arg2), getObject(arg3));
    return addHeapObject(ret);
}, arguments) };

export function __wbg_call_72facd37dbc97ddb() { return handleError(function (arg0, arg1, arg2, arg3, arg4) {
    var ret = getObject(arg0).call(getObject(arg1), getObject(arg2), getObject(arg3), getObject(arg4));
    return addHeapObject(ret);
}, arguments) };

export function __wbg_bind_07839579f523aa89(arg0, arg1, arg2, arg3) {
