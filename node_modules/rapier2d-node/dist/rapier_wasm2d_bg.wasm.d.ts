...
export function rawjointparams_prismatic(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
...
export function rawrigidbodyset_createRigidBody(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number): number;
